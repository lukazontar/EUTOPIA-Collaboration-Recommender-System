...
SELECT ARTICLE_SID
     ...
     , JSON_EXTRACT_SCALAR(JSON_EXTRACT(ARTICLE_CONTAINER_TITLE, '$[0]'), '$.')       AS ARTICLE_CONTAINER_TITLE
     , JSON_EXTRACT_SCALAR(JSON_EXTRACT(ARTICLE_SHORT_CONTAINER_TITLE, '$[0]'), '$.') AS ARTICLE_SHORT_CONTAINER_TITLE
